...
local pyright_cmd = lsp_settings.resolve_executable("pyright-langserver") or "pyright-langserver"
...
return {
  ...
  settings = {
    pyright = {
      -- Let Ruff handle import organization to avoid duplicate fixes.
