...
function M.defaults()
  ...
  local function set_statusline_hl()
    vim.api.nvim_set_hl(0, "OneBeerStatuslineSection", { link = "StatusLine" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineMuted", { link = "Comment" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineAccent", { link = "Title" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineInfo", { link = "DiagnosticInfo" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineWarn", { link = "DiagnosticWarn" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineError", { link = "DiagnosticError" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineModeNormal", { link = "StatusLine" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineModeInsert", { link = "DiagnosticOk" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineModeVisual", { link = "DiagnosticWarn" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineModeReplace", { link = "DiagnosticError" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineModeCommand", { link = "Title" })
    vim.api.nvim_set_hl(0, "OneBeerStatuslineModeTerminal", { link = "Special" })
  end
